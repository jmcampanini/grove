...
func TestPullRequest_UnmarshalJSON(t *testing.T) {
	tests := []struct {
		...
		{
			name: "merged PR with mergeCommit and commits",
			input: `{
				"additions": 50,
				"author": {"login": "dev"},
				"body": "Squash merged",
				"changedFiles": 3,
				"commits": [{"oid": "aaa"}, {"oid": "bbb"}, {"oid": "ccc"}],
				"createdAt": "2024-10-01T00:00:00Z",
				"deletions": 10,
				"headRefName": "feature/fast-init",
				"isDraft": false,
		...
		{
			name: "open PR has no mergeCommit",
			input: `{
				"additions": 5,
				"author": {"login": "dev"},
				"body": "",
			...
			want: PullRequest{
				...
				State:          PRStateOpen,
				Title:          "WIP",
				UpdatedAt:      time.Date(2024, 10, 1, 0, 0, 0, 0, time.UTC),
				URL:            "https://github.com/owner/repo/pull/99",
			},
		},
		{

...
- When creating or modifying struct definitions, prefer sorting grouped fields in alpha order
...
- Use `make build` to build the binary (outputs to `out/grove`); never use `go build` directly
